...
ПРАВИЛО ЗАГОЛОВКА (slide_headline)

Схема: ПРОБЛЕМА -> РЕШЕНИЕ. До 50 символов.

Примеры: «YouTube без рекламы», «Все AI модели в одном окне», «Фото без фона за секунды».

Запрещено: название проекта как главный смысл заголовка. Выгода раньше названия.

ПРАВИЛО КАРТОЧКИ (slide_body)

Ответь только: «Что я получу через 30 секунд после установки?»

Не архитектура. Не устройство. Не технологии. Только результат. До 200 символов.
...
* slide_headline — ПРОБЛЕМА -> РЕШЕНИЕ, <=50 символов
* slide_body — результат через 30 сек, <=200 символов, до 3 коротких предложений
